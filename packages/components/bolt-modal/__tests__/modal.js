...
describe('<bolt-modal> Component', () => {
  ...
  test(
    '<bolt-modal> at various viewport sizes',
    async () => {
  ...
  test(
    '<bolt-modal> with band at various viewport sizes',
    async () => {
      const bandContent = `<bolt-text headline font-size="xxlarge">This is the very long body text.</bolt-text>
