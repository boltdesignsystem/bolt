...
export const FaceSad = ({ bgColor, fgColor, size, ...otherProps }) => {
  return (
    <svg>
      <path
        d="M11.9 14.3c-1.7 0-3.3.8-4.3 2.2l1.1.8c.8-1 1.9-1.6 3.2-1.6s2.5.6 3.2 1.6l1.1-.8c-1-1.4-2.6-2.2-4.3-2.2zM9 9.6c0-.8-.6-1.4-1.4-1.4s-1.4.6-1.4 1.4c0 .8.6 1.4 1.4 1.4S9 10.3 9 9.6z"
        class="st0"
      />
      <path
