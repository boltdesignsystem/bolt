...
return svg`
<svg version="1.1" width="250px" id="el_pdKL5703A" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 348 126" style="enable-background:new 0 0 348 126;" xml:space="preserve"><style>
...
@keyframes kf_el_6ocLR71www_an_UBwLhsVL8 {
    0% {
...
@keyframes kf_connectionArrows2_an_HHL3XQCb8 {
    0% {
...
@keyframes kf_connectionArrows1 {
    ...
    33.33% {
        transform: translate(219.90000915527344px, 1.5px) rotate(5deg) translate(-219.90000915527344px, -1.5px);
    }
    100% {
        transform: translate(219.90000915527344px, 1.5px) rotate(5deg) translate(-219.90000915527344px, -1.5px);
    }
...
@keyframes kf_el_KxVIkpxR1A_an_VovxSGF6J {
    0% {
...
#el_KxVIkpxR1A_an_VovxSGF6J {
     animation-fill-mode: backwards;
     transform: translate(219.90000915527344px, 1.5px) translate(-219.90000915527344px, -1.5px) translate(-256px, 16px);
     animation-name: kf_el_KxVIkpxR1A_an_VovxSGF6J;
     animation-timing-function: cubic-bezier(0, 0, 1, 1);
}
...
#connectionArrows2_an_HHL3XQCb8 {
     animation-fill-mode: backwards;
     transform: translate(126.5999984741211px, 46.5px) translate(-126.5999984741211px, -46.5px) translate(-164px, 0px);
     animation-name: kf_connectionArrows2_an_HHL3XQCb8;
     animation-timing-function: cubic-bezier(0, 0, 1, 1);
}

#el_6ocLR71www_an_UBwLhsVL8 {
     animation-fill-mode: backwards;
     transform: translate(168.10000610351562px, 92.69999694824219px) translate(-168.10000610351562px, -92.69999694824219px) translate(-202px, -15px);
     animation-name: kf_el_6ocLR71www_an_UBwLhsVL8;
     animation-timing-function: cubic-bezier(0, 0, 1, 1);
}
...
<g id="el_KxVIkpxR1A_an_VovxSGF6J" data-animator-group="true" data-animator-type="0"><g id="connectionArrows1" data-animator-group="true" data-animator-type="1"><g id="el_KxVIkpxR1A">
...
<g id="connectionArrows2_an_HHL3XQCb8" data-animator-group="true" data-animator-type="0"><g id="connectionArrows2">
...
<g id="el_6ocLR71www_an_UBwLhsVL8" data-animator-group="true" data-animator-type="0"><g id="connectionArrows3" data-animator-group="true" data-animator-type="1"><g id="el_6ocLR71www">
