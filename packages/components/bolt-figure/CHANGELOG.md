...
## [2.30.3](https://github.com/bolt-design-system/bolt/compare/v2.30.2...v2.30.3) (2021-02-04)
...
* update Jest tests to more reliably work with fully async-loaded components ([6b4c752](https://github.com/bolt-design-system/bolt/commit/6b4c752cfcf32a3d0d260d5e2f718be12fd3df50))
...
* add `media.content` to schema, deprecate specific media types ([5b7501e](https://github.com/bolt-design-system/bolt/commit/5b7501e))
