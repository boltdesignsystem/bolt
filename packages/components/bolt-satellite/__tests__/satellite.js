...
// import schema from '../satellite.schema';
...
describe('Bolt Satellite component', () => {
  test('default', async () => {
    const results = await render(
      '@bolt-components-satellite/satellite.twig',
      {
