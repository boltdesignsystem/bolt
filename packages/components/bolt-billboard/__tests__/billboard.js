...
// import schema from '../billboard.schema';
...
describe('Bolt Billboard component', () => {
  test('default', async () => {
    const results = await render(
      '@bolt-components-billboard/billboard.twig',
      {
