...
class BoltCarousel extends BoltElement {
  ...
  static get properties() {
    return {
      ...
      slidesPerGroup: {
        attribute: 'slides-per-group',
        type: String,
      },
      maxSlidesPerView: {
        attribute: 'max-slides-per-view',
        type: Number,
      },
      spaceBetween: {
      ...
      noNavButtons: {
        type: Boolean,
        attribute: 'no-nav-buttons',
      },
      slideToClickedSlide: {
        type: Boolean,
        attribute: 'slide-to-clicked-slide',
      },
      autoplay: {
        type: Boolean,
      },
      ...
      freeScroll: {
        type: Boolean,
        attribute: 'free-scroll',
      },
      prevSlideMessage: {
        type: String,
        attribute: 'prev-slide-message',
      },
      nextSlideMessage: {
        type: String,
        attribute: 'next-slide-message',
      },
      nextSlideMessage: {
        type: String,
        attribute: 'next-slide-message',
      ...
      firstSlideMessage: {
        type: String,
        attribute: 'first-slide-message',
      },
      lastSlideMessage: {
        type: String,
        attribute: 'last-slide-message',
      },
      paginationBulletMessage: {
        type: String,
        attribute: 'pagination-bullet-message',
      },
      slideOffsetBefore: {
        type: Boolean,
  ...
  constructor() {
    ...
    this.maxSlidesPerView = 3;
    this.spaceBetween = 'medium';
    this.navButtonPosition = 'inside';
    this.overflow = false;
    ...
    this.paginationBulletMessage = 'Go to slide {{index}}';
  }
