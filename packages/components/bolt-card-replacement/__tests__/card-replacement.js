...
const schema = readYamlFileSync(join(__dirname, '../card-replacement.schema.yml'));
...
describe('<bolt-card-replacement> Component', () => {
  ...
  test('basic usage', async () => {
    const results = await render('@bolt-components-card-replacement/card-replacement.twig', {
      media: {
        image: {
