...
# [2.5.0](https://github.com/bolt-design-system/bolt/tree/master/packages/components/bolt-logo/compare/v2.4.4...v2.5.0) (2019-06-21)


### Bug Fixes

* add publicConfig ([2692f94](https://github.com/bolt-design-system/bolt/tree/master/packages/components/bolt-logo/commit/2692f94))
* re-add network timeout to jest tests ([e227628](https://github.com/bolt-design-system/bolt/tree/master/packages/components/bolt-logo/commit/e227628))
* re-update jest + jest-serializer-html packages to the latest versions + remove extra whitespace from snapshots based on jest-serializer-html pkg updates ([3af88ca](https://github.com/bolt-design-system/bolt/tree/master/packages/components/bolt-logo/commit/3af88ca))
