...
module.exports = {
  ...
  'Popover w/ matching open no-JS / SSR state auto-opens but can still be closed': function(
    ...
    browser
      .url(
        `${testingUrl}/pattern-lab/patterns/40-components-popover-30-popover-theme-variations/40-components-popover-30-popover-theme-variations.html#js-bolt-popover-theme-demo-xdark-5`,
      )
  ...
  'Popover w/ matching closed no-JS / SSR state remains closed': function(
    ...
    browser
      .url(
        `${testingUrl}/pattern-lab/patterns/40-components-popover-30-popover-theme-variations/40-components-popover-30-popover-theme-variations.html#js-bolt-popover-trigger-theme-demo-xdark-5`,
      )
      .waitForElementVisible('bolt-popover[uuid="theme-demo-xdark-5"]', 1000)
      .pause(1000)
      .assert.not.visible('#js-bolt-popover-theme-demo-xdark-5')
  ...
  "Popover's URL cleanup doesn't modify existing URL query strings": function(
    ...
    browser
      .url(
        `${testingUrl}/pattern-lab/patterns/40-components-popover-30-popover-theme-variations/40-components-popover-30-popover-theme-variations.html?foo=bar#js-bolt-popover-theme-demo-xdark-5`,
      )
      .waitForElementVisible('bolt-popover[uuid="theme-demo-xdark-5"]', 1000)
      .pause(1000)
      .assert.visible('#js-bolt-popover-theme-demo-xdark-5')
