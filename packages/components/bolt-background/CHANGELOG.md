...
# [2.5.0](https://github.com/bolt-design-system/bolt/tree/master/packages/components/bolt-background/compare/v2.4.4...v2.5.0) (2019-06-21)


### Bug Fixes

* add publicConfig ([2692f94](https://github.com/bolt-design-system/bolt/tree/master/packages/components/bolt-background/commit/2692f94))


### Features

* migrate over remaininig carousel-related docs site and component updates not included in the original component-only PR ([afc75c0](https://github.com/bolt-design-system/bolt/tree/master/packages/components/bolt-background/commit/afc75c0))
