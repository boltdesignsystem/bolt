module.exports = {
  ...
  properties: {
     ...
     lang: {
        description: 'Set language-specific quotation marks. By default, inherits the value of the closest `lang` attribute. While any valid `lang` valid is accepted, choosing `en`, `de`, `fr`, or `ja` will optimize how quotes are displayed in these languages.',
        type: 'string'
     },
     logo: {
