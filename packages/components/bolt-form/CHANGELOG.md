...
# [2.5.0](https://github.com/bolt-design-system/bolt/tree/master/packages/components/bolt-form/compare/v2.4.4...v2.5.0) (2019-06-21)


### Bug Fixes

* add publicConfig ([2692f94](https://github.com/bolt-design-system/bolt/tree/master/packages/components/bolt-form/commit/2692f94))


### Features

* Add support for showErrors custom event to form fields ([674129a](https://github.com/bolt-design-system/bolt/tree/master/packages/components/bolt-form/commit/674129a))
