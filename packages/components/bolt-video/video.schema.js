module.exports = {
  ...
  properties: {
    ...
    enabled_plugins: {
      type: 'string',
      description:
        "Space-separated list of built-in `<bolt-video>` plugins for Brightcove to enable. Current include `social`, `email`, `playback`, and `cue`. For exampl: `<bolt-video enabled-plugins='cue social email playback'>`.",
    },
    disabled_plugins: {
      type: 'string',
      description:
        "Space-separated list of any built-in `<bolt-video>` plugins for Brightcove to disable. Used to opt-out of any video plugins that are enabled by default (ex. the `playback` plugin). For exampl: `<bolt-video disabled-plugins='playback'>`.",
    },
    errorMessage: {
      type: 'string',
      description:
