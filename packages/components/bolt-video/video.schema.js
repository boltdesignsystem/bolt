module.exports = {
  ...
  properties: {
    ...
    default_plugins: {
      type: 'array',
      readonly: true,
      description: 'An array of the default `<bolt-video>` player plugins that are globally enabled by default.',
      enum: [
        'playback'
      ],
      hidden: true
    ...
    available_plugins: {
      type: 'array',
      readonly: true,
      description: 'The built-in `<bolt-video>` player plugins that are availble to be used in any player instance without requiring the use of any extra Javascript.',
      enum: [
        'playback',
        'social',
        'email',
    ...
    enabled_plugins: {
      type: 'string',
      description: 'Space-separated list of built-in `<bolt-video>` plugins for Brightcove to enable. Current include `social`, `email`, `playback`, and `cue`. For exampl: `<bolt-video enabled-plugins=\'cue social email playback\'>`.'
    },
    disabled_plugins: {
      type: 'string',
      description: 'Space-separated list of any built-in `<bolt-video>` plugins for Brightcove to disable. Used to opt-out of any video plugins that are enabled by default (ex. the `playback` plugin). For exampl: `<bolt-video disabled-plugins=\'playback\'>`.'
    },
    errorMessage: {
      type: 'string',
