...
layout: page
title: 'Font Sizes'
intro: 'npm install @bolt/settings-font-sizes'
permalink: /settings/font-sizes/
---
...
- [Guide: EM vs REM vs PX. Which should you use?](http://engageinteractive.co.uk/blog/em-vs-rem-vs-px)
