...
export default class PaginationBoxView extends Component {
  ...
  render() {
    const { renderOnZeroPageCount, translate } = this.props;
    ...
    return (
      <ul className={className || containerClassName} role="menu">
        <li className={previousClasses} role="menu-item">
          <Button
            hierarchy="transparent"
            size="small"
            borderRadius="full"
            iconBefore={<IconChevronLeft size="small" />}
            className={previousLinkClasses}
            tabIndex={isPreviousDisabled ? '-1' : '0'}
            onKeyPress={this.handlePreviousPage}
            disabled={previousAriaDisabled === 'true' || false}
            aria-label={translate(previousAriaLabel)}
        ...
        <li className={nextClasses} role="menu-item">
          <Button
            hierarchy="transparent"
            size="small"
            borderRadius="full"
            iconAfter={<IconChevronRight size="small" />}
            className={nextLinkClasses}
            tabIndex={isNextDisabled ? '-1' : '0'}
            onKeyPress={this.handleNextPage}
            disabled={nextAriaDisabled === 'true' || false}
            aria-label={translate(nextAriaLabel)}
