...
module.exports = {
  ...
  properties: {
    ...
    align_items: {
      type: 'string',
      description: 'Control the horizontal alignment all layout items.',
    ...
    valign_items: {
      type: 'string',
      description:
        'Control the vertical alignment all layout items. Unset is required for setting equal-height layout items.',
      enum: ['unset', 'start', 'center', 'end'],
      default: 'unset',
    },
    background: {
