...
Font weight settings based on Pega branding and accessibility. Part of the Bolt “Core” CSS framework that powers the [Bolt Design System](https://www.boltdesignsystem.com).

- [Sassdocs](https://www.boltdesignsystem.com/docs/#settings:%20typography-variable-font-weight)
- Demo (Coming Soon)
...
```
npm install @bolt/settings-font-weight
```
...
Installing Bolt’s font-weight settings is as easy as running NPM install:
