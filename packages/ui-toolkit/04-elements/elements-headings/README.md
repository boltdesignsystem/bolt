...
Generic heading elements. Part of the Bolt “Core” CSS framework that powers the [Bolt Design System](https://www.boltdesignsystem.com).
...
```
npm install @bolt/elements-headings
```

### Generic Heading Resets

Generic `h1` to `h6` elements have been reset to use Bolt’s bold weight, and browser default spacing have been canceled.
...
Installing Bolt’s heading elements is as easy as running NPM install:
