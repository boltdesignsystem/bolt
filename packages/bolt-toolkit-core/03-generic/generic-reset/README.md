...
Generic reset. Part of the Bolt “Core” CSS framework that powers the [Bolt Design System](https://www.boltdesignsystem.com).
...
Installing Bolt’s generic reset is as easy as running NPM install:
...
```
// Generic
@import ‘@bolt/generic-reset’
...

// Elements
@import ‘@bolt/elements-...’
```
