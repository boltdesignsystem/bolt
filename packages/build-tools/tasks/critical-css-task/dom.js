// Originally ported over from https://github.com/GoogleChromeLabs/critters/blob/master/src/dom.js -- modified to work with Node.js without having to pre-compile the build task (or use .mjs)
...
function createDocument(html) {
  ...
  // Original assignment before updating to pass eslint -- just in case!
  // const scratch = (document.$$scratchElement = document.createElement('div'));
  const scratch = document.createElement('div');
  document.$$scratchElement = document.createElement('div');
