  ...
  merger: new DataMerger({
    rules: {
      ...
      'json-file': {
        ...
        map: [
          new mappers.FileLoader(),
          new mappers.JsonDecoder(),
        ],
      },
      ...
      'twig-namespaces': {
        match: [
          new matchers.MatchKey(key => path.basename(key) === 'twig-namespaces.bolt.json'),
        ],
        reduce: [
          new reducers.TwigNamespaceReducer(),
        ],
        final: true,
      },
      ...
      'default-merger': {
        match: [
          new matchers.MatchDataFormat('RawObjectData'),
        ],
        reduce: [
          new reducers.DeepMergeReducer(),
        ],
      }
    },
  }),
