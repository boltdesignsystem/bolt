...
var modalViewer = {
  ...
  */
  onReady: function() {
    patternInfoToggle = $('.js-pattern-info-toggle');
    ...
    patternInfoToggle.click(function(e) {
      e.preventDefault();
    ...
    if (DataSaver.findValue('modalActive') === 'true') {
      ...
      patternInfoToggle.html("Hide Pattern Info");
    }
  ...
  */
  close: function() {
    ...
    // update the wording
    patternInfoToggle.html("Show Pattern Info");
