...
* don't try and auto-assign Selenium port when doing local Nightwatch development ([6f6b8b6](https://github.com/bolt-design-system/bolt/commit/6f6b8b6))
* update Chrome Driver to the latest version of Chrome to fix issues running Nightwatch locally ([4c78ac2](https://github.com/bolt-design-system/bolt/commit/4c78ac2))
