...
const corePhpPath = path.join(__dirname, '../../packages/php/shared-twig-extensions/composer.json');
const corePhp = require(corePhpPath);
corePhp.version = lernaVersion;
fs.writeFileSync(corePhpPath, JSON.stringify(corePhp, null, '  '));

const boltConnectPath = path.join(__dirname, '../../packages/php/bolt-connect-drupal-module/composer.json');
...
const boltConnectInfoPath = path.join(__dirname, '../../packages/php/bolt-connect-drupal-module/bolt_connect.info.yml');
