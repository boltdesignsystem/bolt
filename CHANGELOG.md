...
* add content to schema ([8bb3dd5](https://github.com/bolt-design-system/bolt/commit/8bb3dd5))
* add DIY lit-html renderer to uikit to remove lit-html version warnings from the NPM package ([47749da](https://github.com/bolt-design-system/bolt/commit/47749da))
* add first/last classes to slotted children ([eb39bae](https://github.com/bolt-design-system/bolt/commit/eb39bae))
* add improved method of hydrating ssr-rendered HTML more precisely. addresses issue the accordion component flashing when booting up using <replace-with-children> and <replace-with-grandchildren> ([a183338](https://github.com/bolt-design-system/bolt/commit/a183338))
* add missing AccordionItem imports ([341e571](https://github.com/bolt-design-system/bolt/commit/341e571))
* add missing closing comment ([914ca02](https://github.com/bolt-design-system/bolt/commit/914ca02))
* add missing stack component to .boltrc config ([54794b6](https://github.com/bolt-design-system/bolt/commit/54794b6))
* add no-verify to now.sh alias to prevent failures from now.sh timing out ([83c6cd8](https://github.com/bolt-design-system/bolt/commit/83c6cd8))
...
* add smaller Jest config to allow us to quickly run a subset of Jest tests ([6e07555](https://github.com/bolt-design-system/bolt/commit/6e07555))
* add testing folder to locations automatically transpiled by Jest / Babel ([a5ac6df](https://github.com/bolt-design-system/bolt/commit/a5ac6df))
* address prettier issues ([38b8d83](https://github.com/bolt-design-system/bolt/commit/38b8d83))
* always add display and cursor classes, even defaults ([5e6230d](https://github.com/bolt-design-system/bolt/commit/5e6230d))
* automate prop styles ([3c0418a](https://github.com/bolt-design-system/bolt/commit/3c0418a))
* bolt-trigger closing tag ([ab47b2a](https://github.com/bolt-design-system/bolt/commit/ab47b2a))
...
* check for item.renderRoot before using it, fixes IE error ([b64845c](https://github.com/bolt-design-system/bolt/commit/b64845c))
* check if values are numeric and do not contain float before getting gcd ([db8d074](https://github.com/bolt-design-system/bolt/commit/db8d074))
...
* check that 'rendered' event emitted by 'bolt-accordion-icon', breaks accordion otherwise ([95f3cf9](https://github.com/bolt-design-system/bolt/commit/95f3cf9))
* close button color ([61681e7](https://github.com/bolt-design-system/bolt/commit/61681e7))
* close button focus on render ([7a9b810](https://github.com/bolt-design-system/bolt/commit/7a9b810))
* close button for small screens ([969cbe7](https://github.com/bolt-design-system/bolt/commit/969cbe7))
* code cleanup and make scaling effect more subtle ([e00e8a0](https://github.com/bolt-design-system/bolt/commit/e00e8a0))
* conditionally add style to attributes object ([2a949c3](https://github.com/bolt-design-system/bolt/commit/2a949c3))
...
* doc comments ([05f32aa](https://github.com/bolt-design-system/bolt/commit/05f32aa))
* doc site boltrc ([bce361c](https://github.com/bolt-design-system/bolt/commit/bce361c))
* downgrade element.closest polyfill as a workaround to address an IE 11 issue with the more recent version ([b9b036a](https://github.com/bolt-design-system/bolt/commit/b9b036a))
* exclude non-Bolt components from getting tested by Jest ([ee527d3](https://github.com/bolt-design-system/bolt/commit/ee527d3))
* extra white-space, double focus around bolt-trigger ([95796cb](https://github.com/bolt-design-system/bolt/commit/95796cb))
...
* fix eslint issues ([924f81f](https://github.com/bolt-design-system/bolt/commit/924f81f))
* fix eslint issues ([2d3cac5](https://github.com/bolt-design-system/bolt/commit/2d3cac5))
* fix eslint issues ([cb576da](https://github.com/bolt-design-system/bolt/commit/cb576da))
* fix linting issues + reduce the overall Nightwatch test report size by around half to prevent the Github API status report from exceeding the max size allowed ([c2907f7](https://github.com/bolt-design-system/bolt/commit/c2907f7))
* fix modal schema indentation ([47ae181](https://github.com/bolt-design-system/bolt/commit/47ae181))
...
* hide modal header when slot is empty ([80953d5](https://github.com/bolt-design-system/bolt/commit/80953d5))
...
* IE11 modal JS errors, broken focus ([0c348db](https://github.com/bolt-design-system/bolt/commit/0c348db))
* ignore linting generators folder ([4ac8a20](https://github.com/bolt-design-system/bolt/commit/4ac8a20))
* inside nav buttons in IE11 ([d53173f](https://github.com/bolt-design-system/bolt/commit/d53173f))
* install all deps when running full suite of jest tests ([4c07439](https://github.com/bolt-design-system/bolt/commit/4c07439))
* last child spacing ([e00efa8](https://github.com/bolt-design-system/bolt/commit/e00efa8))
* lint ([cfc6caf](https://github.com/bolt-design-system/bolt/commit/cfc6caf))
* lint css ([fb7bfea](https://github.com/bolt-design-system/bolt/commit/fb7bfea))
* lint js ([243545a](https://github.com/bolt-design-system/bolt/commit/243545a))
* lint js ([76d6177](https://github.com/bolt-design-system/bolt/commit/76d6177))
* lint js ([e15b6af](https://github.com/bolt-design-system/bolt/commit/e15b6af))
* lint js ([cec9099](https://github.com/bolt-design-system/bolt/commit/cec9099))
* lint js ([fe21067](https://github.com/bolt-design-system/bolt/commit/fe21067))
* linting ([e2ee333](https://github.com/bolt-design-system/bolt/commit/e2ee333))
* linting ([19215e1](https://github.com/bolt-design-system/bolt/commit/19215e1))
* linting ([c3d0cd3](https://github.com/bolt-design-system/bolt/commit/c3d0cd3))
* logic that hides modal header ([e549af9](https://github.com/bolt-design-system/bolt/commit/e549af9))
* major IE 11 fix causing all swiper carousel code to fail to run ([ff2b76a](https://github.com/bolt-design-system/bolt/commit/ff2b76a))
* make replace-with-grandchildren element span full-width ([53c8086](https://github.com/bolt-design-system/bolt/commit/53c8086))
* max width ([30f1deb](https://github.com/bolt-design-system/bolt/commit/30f1deb))
...
* naming conventions and tests update ([1ecf740](https://github.com/bolt-design-system/bolt/commit/1ecf740))
* nav position ([daf6442](https://github.com/bolt-design-system/bolt/commit/daf6442))
* no js focus ([3ef9626](https://github.com/bolt-design-system/bolt/commit/3ef9626))
* no-js styles, cleanup CSS, use proper BEM classnames ([6bfee44](https://github.com/bolt-design-system/bolt/commit/6bfee44))
* no-separator prop name ([7bd1115](https://github.com/bolt-design-system/bolt/commit/7bd1115))
* not removing state input on load ([b819e13](https://github.com/bolt-design-system/bolt/commit/b819e13))
* outside nav buttons ([2cefd78](https://github.com/bolt-design-system/bolt/commit/2cefd78))
* padding around icon ([625794e](https://github.com/bolt-design-system/bolt/commit/625794e))
* pagination label ([3123802](https://github.com/bolt-design-system/bolt/commit/3123802))
* partial fix for IE 11 arrow icon styles ([a1b11bd](https://github.com/bolt-design-system/bolt/commit/a1b11bd))
* partial workaround to Drupal Lab build failing until v2.4.x hotfix released ([fe61ac4](https://github.com/bolt-design-system/bolt/commit/fe61ac4))
* polyfill 'remove()' to fix IE11 errors in accordion ([c856491](https://github.com/bolt-design-system/bolt/commit/c856491))
* prevent mutation observer from re-rendering when using light dom ([f30c99d](https://github.com/bolt-design-system/bolt/commit/f30c99d))
* prevent scroll when modal is open ([81ef7bf](https://github.com/bolt-design-system/bolt/commit/81ef7bf))
* prop validation errors on carousel ([1cf9e73](https://github.com/bolt-design-system/bolt/commit/1cf9e73))
* re-add dependencies used by Travis ([4f1eb6f](https://github.com/bolt-design-system/bolt/commit/4f1eb6f))
* re-add missing onClick, onClickTarget props ([eca8c39](https://github.com/bolt-design-system/bolt/commit/eca8c39))
...
* re-enable default browsersync ghost mode ([81ce793](https://github.com/bolt-design-system/bolt/commit/81ce793))
* re-organize css ([a53b624](https://github.com/bolt-design-system/bolt/commit/a53b624))
* re-update carousel Jest image snapshot ([0189e24](https://github.com/bolt-design-system/bolt/commit/0189e24))
...
* readme ([cd60356](https://github.com/bolt-design-system/bolt/commit/cd60356))
* remove 'inherit', must use 'medium' ([7cf87df](https://github.com/bolt-design-system/bolt/commit/7cf87df))
* remove animated placeholders ([f14b82f](https://github.com/bolt-design-system/bolt/commit/f14b82f))
* remove async from describe ([266d63f](https://github.com/bolt-design-system/bolt/commit/266d63f))
* remove debugging style ([7919a88](https://github.com/bolt-design-system/bolt/commit/7919a88))
...
* remove is shadow-root from JS rendered blockquote HTML ([db97dcc](https://github.com/bolt-design-system/bolt/commit/db97dcc))
* remove line-breaks in lit-html renderer, space in link.js to prevent extra whitespace ([c5b4e88](https://github.com/bolt-design-system/bolt/commit/c5b4e88))
...
* remove obsolete comment ([690ccdb](https://github.com/bolt-design-system/bolt/commit/690ccdb))
* remove persistent prop ([b491ac2](https://github.com/bolt-design-system/bolt/commit/b491ac2))
* remove quotes ([7e78b69](https://github.com/bolt-design-system/bolt/commit/7e78b69))
* remove set statement in accordion template ([69f2c86](https://github.com/bolt-design-system/bolt/commit/69f2c86))
* remove trailing white space in inline image styles, update snapshot ([2edc070](https://github.com/bolt-design-system/bolt/commit/2edc070))
* remove transition from bolt-trigger, breaking modal focus trap JS ([d1756bd](https://github.com/bolt-design-system/bolt/commit/d1756bd))
* remove unneeded 'sourceFilesFrom' key in accordion package.json ([7078e9f](https://github.com/bolt-design-system/bolt/commit/7078e9f))
* remove unused 'render' import ([ea39241](https://github.com/bolt-design-system/bolt/commit/ea39241))
* remove yarn offline flag ([1d03f15](https://github.com/bolt-design-system/bolt/commit/1d03f15))
...
* replace gmp_gcd with custom gcd function to avoid gmp dependency ([b5487a1](https://github.com/bolt-design-system/bolt/commit/b5487a1))
* Restore Bolt namespaces	on Drupal admin info page ([3e70e91](https://github.com/bolt-design-system/bolt/commit/3e70e91))
* revert to using a slightly packages in PL UIKit as a workaround to the recent JS errors getting thrown by the React tooltip library used internally ([8eb5f99](https://github.com/bolt-design-system/bolt/commit/8eb5f99))
* rework `replace-with` structure so that content remaining is in correct order ([4139d53](https://github.com/bolt-design-system/bolt/commit/4139d53))
* rework how "outside" click triggers modal to close, fixes broken scrollbar bug ([8fefa27](https://github.com/bolt-design-system/bolt/commit/8fefa27))
* rework video JS to prevent bugs that result from multiple initializations ([45bbf07](https://github.com/bolt-design-system/bolt/commit/45bbf07))
* schema docs error when nested props have multiple types ([700b076](https://github.com/bolt-design-system/bolt/commit/700b076))
* scrollbar issue in IE11 ([159ff40](https://github.com/bolt-design-system/bolt/commit/159ff40))
* selectively hide less essential controls for smaller screens ([d5ab71d](https://github.com/bolt-design-system/bolt/commit/d5ab71d))
* shadow and border radius ([00590a0](https://github.com/bolt-design-system/bolt/commit/00590a0))
* skip props with type object and array in JS, breaks all props in IE ([b274f76](https://github.com/bolt-design-system/bolt/commit/b274f76))
* spacing ([eb8f2fa](https://github.com/bolt-design-system/bolt/commit/eb8f2fa))
* spacing class ([3951bb5](https://github.com/bolt-design-system/bolt/commit/3951bb5))
* speed up initial accordion rendering ([8f0012b](https://github.com/bolt-design-system/bolt/commit/8f0012b))
...
* temporarily disable loop mode in the carousel until related rendering bugs are troubleshooted ([7b65945](https://github.com/bolt-design-system/bolt/commit/7b65945))
* temporarily disable modal Jest tests ([2eaac1b](https://github.com/bolt-design-system/bolt/commit/2eaac1b))
...
* test updating nightwatch test reporting logic to troubleshoot travis jobs not fully completing ([8acca82](https://github.com/bolt-design-system/bolt/commit/8acca82))
* tests ([6005d3a](https://github.com/bolt-design-system/bolt/commit/6005d3a))
* tests ([727eb87](https://github.com/bolt-design-system/bolt/commit/727eb87))
...
* Treat cell.content as renderable in table component ([ad2c0f3](https://github.com/bolt-design-system/bolt/commit/ad2c0f3))
* trigger doc ([03e1406](https://github.com/bolt-design-system/bolt/commit/03e1406))
* trigger e2e failing on travis not local, try increasing wait time ([0123cc8](https://github.com/bolt-design-system/bolt/commit/0123cc8))
* troubleshoot nightwatch test timeout ([2af1e39](https://github.com/bolt-design-system/bolt/commit/2af1e39))
* twig rendered class names ([75adcfd](https://github.com/bolt-design-system/bolt/commit/75adcfd))
...
* update accordion pre-render cleanup logic to better account for deeply nested content ([224809a](https://github.com/bolt-design-system/bolt/commit/224809a))
* Update and simplify twig variables ([1b60e8e](https://github.com/bolt-design-system/bolt/commit/1b60e8e))
* update blockquote snapshot ([c72d45f](https://github.com/bolt-design-system/bolt/commit/c72d45f))
* update broken link to getting started guide on the docs site ([d76fbb1](https://github.com/bolt-design-system/bolt/commit/d76fbb1))
* update carousel Jest snapshots ([9d983a8](https://github.com/bolt-design-system/bolt/commit/9d983a8))
* update component generator to be working as expected ([ade000c](https://github.com/bolt-design-system/bolt/commit/ade000c))
...
* update e2e testing url ([f470a02](https://github.com/bolt-design-system/bolt/commit/f470a02))
* update eslint config path + fix lint issues ([fb02b22](https://github.com/bolt-design-system/bolt/commit/fb02b22))
* update failing stack component tests ([3f57e82](https://github.com/bolt-design-system/bolt/commit/3f57e82))
* update figure twig template so that initial tags are fully replaced by JS-rendered template ([f9b3cf2](https://github.com/bolt-design-system/bolt/commit/f9b3cf2))
* update jest snapshots ([d767bef](https://github.com/bolt-design-system/bolt/commit/d767bef))
* update Jest tests to reflect updated ssr hydration technique ([9b62ba8](https://github.com/bolt-design-system/bolt/commit/9b62ba8))
* update lerna config + image build task to try and improve install + build stability ([826c6e2](https://github.com/bolt-design-system/bolt/commit/826c6e2))
* update navbar Jest test to wait until page navigation has finished. fixes inconsistent navbar test ([89ab34c](https://github.com/bolt-design-system/bolt/commit/89ab34c))
* update nightwatch config path ([7f3de74](https://github.com/bolt-design-system/bolt/commit/7f3de74))
* update Nightwatch e2e test url ([3bebc2c](https://github.com/bolt-design-system/bolt/commit/3bebc2c))
* update Nightwatch e2e test url ([5ac1a66](https://github.com/bolt-design-system/bolt/commit/5ac1a66))
* update Nightwatch test url ([ba44f55](https://github.com/bolt-design-system/bolt/commit/ba44f55))
...
* update onInit script to follow best practices for referencing and configuring a video ([c719283](https://github.com/bolt-design-system/bolt/commit/c719283))
* update package.json post-merge from master ([35528a0](https://github.com/bolt-design-system/bolt/commit/35528a0))
...
* update schema and docs ([9cdc0d5](https://github.com/bolt-design-system/bolt/commit/9cdc0d5))
* update snapshots ([6c2c131](https://github.com/bolt-design-system/bolt/commit/6c2c131))
* update snapshots and jest tests ([6289b18](https://github.com/bolt-design-system/bolt/commit/6289b18))
* update stylelint rules ([9a286dc](https://github.com/bolt-design-system/bolt/commit/9a286dc))
* update text component styles to work while encapsulated in the Shadow DOM ([5b93b8e](https://github.com/bolt-design-system/bolt/commit/5b93b8e))
* update Twig template logic to address compiling error ([13198f7](https://github.com/bolt-design-system/bolt/commit/13198f7))
* update uikit packages to fix build errors ([eed7dc0](https://github.com/bolt-design-system/bolt/commit/eed7dc0))
...
* use more specific selectors in trigger e2e test now that there are multiple triggers ([074dd0b](https://github.com/bolt-design-system/bolt/commit/074dd0b))
* use video-js element per Brightcove best practices ([e96d776](https://github.com/bolt-design-system/bolt/commit/e96d776))
...
* add 'dev' uuid for testing ([5ee35ae](https://github.com/bolt-design-system/bolt/commit/5ee35ae))
...
* add 'scroll' and 'auto' overflow utility classes ([362b19e](https://github.com/bolt-design-system/bolt/commit/362b19e))
* add ability to build and deploy drupal lab instance to help with testing to verify that the build tools continue to work as expected + allow for more drupal testing moving forward ([83ccf23](https://github.com/bolt-design-system/bolt/commit/83ccf23))
...
* add auto-open prop ([5597283](https://github.com/bolt-design-system/bolt/commit/5597283))
* add bolt-trigger component ([1e84819](https://github.com/bolt-design-system/bolt/commit/1e84819))
* add button-style outer glow active state ([4852a22](https://github.com/bolt-design-system/bolt/commit/4852a22))
* add class to modal close-button on focus, emit trigger custom focus/blur events ([ebc7ef9](https://github.com/bolt-design-system/bolt/commit/ebc7ef9))
...
* add icon-valign prop support ([2a252c0](https://github.com/bolt-design-system/bolt/commit/2a252c0))
* add last-item class to accordion-item JS ([702b987](https://github.com/bolt-design-system/bolt/commit/702b987))
* add modal component scaffolding via yeoman generator ([d2f8e1f](https://github.com/bolt-design-system/bolt/commit/d2f8e1f))
* add mutation observer, update accordion when child items change ([8a2d8b0](https://github.com/bolt-design-system/bolt/commit/8a2d8b0))
* add new and improved waitpage that works with webpack-dev-server ([513754f](https://github.com/bolt-design-system/bolt/commit/513754f))
...
* add support for multiple items open at once ([c40a82e](https://github.com/bolt-design-system/bolt/commit/c40a82e))
* Add support for showErrors custom event to form fields ([674129a](https://github.com/bolt-design-system/bolt/commit/674129a))
* add timed modal example ([c05555b](https://github.com/bolt-design-system/bolt/commit/c05555b))
* add uuid to modal ([71a53e5](https://github.com/bolt-design-system/bolt/commit/71a53e5))
* close modal on overlay click if not persistent ([8f89c24](https://github.com/bolt-design-system/bolt/commit/8f89c24))
* comment out box-shadow to avoid dupe layers of shadow ([5619140](https://github.com/bolt-design-system/bolt/commit/5619140))
* conditionally output footer wrapper ([863e035](https://github.com/bolt-design-system/bolt/commit/863e035))
* CSS updates, wip ([f77eab7](https://github.com/bolt-design-system/bolt/commit/f77eab7))
* fix broken CSS rules, add missing spacing-none rule ([7cabd63](https://github.com/bolt-design-system/bolt/commit/7cabd63))
* inherit shadow dom support from parent component ([d1e4c54](https://github.com/bolt-design-system/bolt/commit/d1e4c54))
...
* migrate focus-trap helper element ([c11f942](https://github.com/bolt-design-system/bolt/commit/c11f942))
...
* move addClassesToSlottedChildren to base class, pass slot names as param ([41017fe](https://github.com/bolt-design-system/bolt/commit/41017fe))
* move getModifiedSchema to base, refactor how schema gets updated ([ba52b40](https://github.com/bolt-design-system/bolt/commit/ba52b40))
* namespace bolt-custom-element-styles mixin ([239c007](https://github.com/bolt-design-system/bolt/commit/239c007))
* namespace modal 'ready' custom event ([bea6a3f](https://github.com/bolt-design-system/bolt/commit/bea6a3f))
* only re-initialize carousel if slidesPerView changes ([9932c56](https://github.com/bolt-design-system/bolt/commit/9932c56))
...
* remove 'tag' as trigger prop, JS clean up ([2053151](https://github.com/bolt-design-system/bolt/commit/2053151))
* remove srcset not found example from image page ([9504625](https://github.com/bolt-design-system/bolt/commit/9504625))
* rename 'auto-open' prop to 'open' ([f65180d](https://github.com/bolt-design-system/bolt/commit/f65180d))
...
* rename no-separator prop in schema ([f5ba3e8](https://github.com/bolt-design-system/bolt/commit/f5ba3e8))
* rename prop 'multiple' to 'single' ([ad16304](https://github.com/bolt-design-system/bolt/commit/ad16304))
* rework accordion item twig template to remove unneeded elements on load ([b029479](https://github.com/bolt-design-system/bolt/commit/b029479))
* set default accordion iconValign value to 'center' ([190c107](https://github.com/bolt-design-system/bolt/commit/190c107))
* speed up yarn install by adding lerna config flags ([ab0e395](https://github.com/bolt-design-system/bolt/commit/ab0e395))
* update accordion icons ([d58bd26](https://github.com/bolt-design-system/bolt/commit/d58bd26))
* update accordion options on re-render ([74819ac](https://github.com/bolt-design-system/bolt/commit/74819ac))
* update basic demo ([c04b2b1](https://github.com/bolt-design-system/bolt/commit/c04b2b1))
* update JS to remove unneeded elements on load, throttle resize ([c6ba2cb](https://github.com/bolt-design-system/bolt/commit/c6ba2cb))
...
* update Twig + JS to reflect new iconValign default ([2d7f74e](https://github.com/bolt-design-system/bolt/commit/2d7f74e))
* updating modal POC with latest work ([a9bdfcd](https://github.com/bolt-design-system/bolt/commit/a9bdfcd))
* use schema validation in accordion JS ([9129e20](https://github.com/bolt-design-system/bolt/commit/9129e20))
* validate modal props ([000f2ba](https://github.com/bolt-design-system/bolt/commit/000f2ba))
* wrap classnames in `css()` helper ([8cb6dba](https://github.com/bolt-design-system/bolt/commit/8cb6dba))
