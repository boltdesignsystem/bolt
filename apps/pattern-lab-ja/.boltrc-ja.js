...
const config = require('../pattern-lab/.boltrc');
const deepmerge = require('deepmerge');

const configJa = {
  lang: 'ja',
  port: 8081,
  buildDir: '../../www/pattern-lab/ja/build',
  wwwDir: '../../www',
  extraTwigNamespaces: {
    'bolt': {
      recursive: true,
    ...
    'bolt-assets': {
      recursive: true,
      paths: ['../../www/pattern-lab/ja'],
    },
    utils: {
      recursive: true,
      paths: ['../pattern-lab/src/_includes'],
    },
  },
  // extraTwigNamespaces: {
  //   // 'bolt-assets': {
  ...
  // images: {
  //   sets: [{
  //     base: '../pattern-lab/src/assets/images',
  //     glob: '**',
  //     dist: '../../www/pattern-lab/ja/images/',
  //   }, ],
  // },
  // components: {
  //   individual: [
  //     // {
  //     //   name: 'pl',
  //     //   scss: '../pattern-lab/src/styles/pl.scss',
  //     //   js: '../pattern-lab/src/scripts/pl.js',
  //     // },
