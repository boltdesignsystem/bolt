...
const ExitFullScreen = ({ color, size, ...otherProps }) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...otherProps}>
      ...
      <defs>
        <path id="id-40a" d="M9.987 8.98V0H.992v8.978h8.995z" />
        <path id="id-42c" d="M0 9h8.996V0H0z" />
      </defs>
      <g fill="currentColor" fill-rule="evenodd">
        ...
        <g transform="translate(12 3)">
          <mask id="id-41b" fill="#fff">
            <use xlinkHref="#id-40a" />
          </mask>
          <path
        ...
        <g transform="translate(2 14)">
          <mask id="id-43d" fill="#fff">
            <use xlinkHref="#id-42c" />
          </mask>
          <path
