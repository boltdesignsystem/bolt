    ...
    const element = `
      ...
      return (
        ${
          ...
          .replace('d="M6 6h12v12H6z"', '') // workaround to manually remove rectangles in certain exported SVGs (covers up icon otherwise)
          .replace('d="M-1-1h24v24H-1z"', '') // workaround to manually remove rectangles in certain exported SVGs (covers up icon otherwise)
          .replace('d="M0 0h24v24H0z"', '') // workaround to manually remove rectangles in certain exported SVGs (covers up icon otherwise)
          .replace('d="M0 0h24v25H0z"', '') // workaround to manually remove rectangles in certain exported SVGs (covers up icon otherwise)
