...
const config = {
  ...
  components: {
    global: [
      /**
       * uncomment the array of items below + comment out line 257 to test compiling everything as an array of files passed into one Webpack entry vs just one .scss file
       **/
      ...
      /**
       * uncomment the items above + comment out line 257 below to test compiling everything as an array of files passed into one Webpack entry vs just one .scss file
       **/
