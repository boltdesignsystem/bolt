...
// Progress Bar Demos
import './pages/pattern-lab/_patterns/02-components/progress-bar/advanced-usage--programmatically-updated/-progress-bar--programmatically-updated-example';
import './pages/pattern-lab/_patterns/02-components/progress-bar/advanced-usage--stepper/-progress-bar--stepper-example';
